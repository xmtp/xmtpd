...
interface IPayer {
    ...
    /// @dev Error thrown when a payer is already registered.
    error PayerAlreadyRegistered(address);

    /// @dev Error thrown when a payer does not exist.
    error PayerDoesNotExist(address);
    ...
    /// @dev Error thrown in case of an unauthorized access.
    error Unauthorized();
     ...
     * @param payer The address to check.
     * @return withdrawal The withdrawal status of the payer.
     */
    ...
    */
     ...
     * @param _payerReportContract The address of the new payer report contract.
     *
     * Emits `PayerReportContractUpdated`.
     */
    function setPayerReportContract(address _payerReportContract) external;
