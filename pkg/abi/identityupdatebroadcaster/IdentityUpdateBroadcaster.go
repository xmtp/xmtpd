...
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterCaller) ContractName(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _IdentityUpdateBroadcaster.contract.Call(opts, &out, "contractName")
...
//
// Solidity: function contractName() pure returns(string contractName_)
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterSession) ContractName() (string, error) {
	return _IdentityUpdateBroadcaster.Contract.ContractName(&_IdentityUpdateBroadcaster.CallOpts)
}

// ContractName is a free data retrieval call binding the contract method 0x75d0c0dc.
//
// Solidity: function contractName() pure returns(string contractName_)
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterCallerSession) ContractName() (string, error) {
	return _IdentityUpdateBroadcaster.Contract.ContractName(&_IdentityUpdateBroadcaster.CallOpts)
}
...
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _IdentityUpdateBroadcaster.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() pure returns(string version_)
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterSession) Version() (string, error) {
	return _IdentityUpdateBroadcaster.Contract.Version(&_IdentityUpdateBroadcaster.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() pure returns(string version_)
func (_IdentityUpdateBroadcaster *IdentityUpdateBroadcasterCallerSession) Version() (string, error) {
	return _IdentityUpdateBroadcaster.Contract.Version(&_IdentityUpdateBroadcaster.CallOpts)
}
