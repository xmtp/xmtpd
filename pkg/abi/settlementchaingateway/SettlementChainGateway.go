...
// FilterDeposit is a free log retrieval operation binding the contract event 0x33da4f9b82b3e18a281ca2cabbe2f076925692abb593b7ea3f850009e8ec9770.
//
// Solidity: event Deposit(uint256 indexed chainId, uint256 indexed messageNumber, uint256 amount)
func (_SettlementChainGateway *SettlementChainGatewayFilterer) FilterDeposit(opts *bind.FilterOpts, chainId []*big.Int, messageNumber []*big.Int) (*SettlementChainGatewayDepositIterator, error) {
	...
	logs, sub, err := _SettlementChainGateway.contract.FilterLogs(opts, "Deposit", chainIdRule, messageNumberRule)
	if err != nil {
		return nil, err
	}
...
// WatchDeposit is a free log subscription operation binding the contract event 0x33da4f9b82b3e18a281ca2cabbe2f076925692abb593b7ea3f850009e8ec9770.
//
// Solidity: event Deposit(uint256 indexed chainId, uint256 indexed messageNumber, uint256 amount)
func (_SettlementChainGateway *SettlementChainGatewayFilterer) WatchDeposit(opts *bind.WatchOpts, sink chan<- *SettlementChainGatewayDeposit, chainId []*big.Int, messageNumber []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _SettlementChainGateway.contract.WatchLogs(opts, "Deposit", chainIdRule, messageNumberRule)
	if err != nil {
		return nil, err
	}
...
// ParseDeposit is a log parse operation binding the contract event 0x33da4f9b82b3e18a281ca2cabbe2f076925692abb593b7ea3f850009e8ec9770.
//
// Solidity: event Deposit(uint256 indexed chainId, uint256 indexed messageNumber, uint256 amount)
