...
func (_SettlementChainGateway *SettlementChainGatewayCaller) ContractName(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _SettlementChainGateway.contract.Call(opts, &out, "contractName")
...
//
// Solidity: function contractName() pure returns(string contractName_)
func (_SettlementChainGateway *SettlementChainGatewaySession) ContractName() (string, error) {
	return _SettlementChainGateway.Contract.ContractName(&_SettlementChainGateway.CallOpts)
}

// ContractName is a free data retrieval call binding the contract method 0x75d0c0dc.
//
// Solidity: function contractName() pure returns(string contractName_)
func (_SettlementChainGateway *SettlementChainGatewayCallerSession) ContractName() (string, error) {
	return _SettlementChainGateway.Contract.ContractName(&_SettlementChainGateway.CallOpts)
}
...
func (_SettlementChainGateway *SettlementChainGatewayCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _SettlementChainGateway.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() pure returns(string version_)
func (_SettlementChainGateway *SettlementChainGatewaySession) Version() (string, error) {
	return _SettlementChainGateway.Contract.Version(&_SettlementChainGateway.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() pure returns(string version_)
func (_SettlementChainGateway *SettlementChainGatewayCallerSession) Version() (string, error) {
	return _SettlementChainGateway.Contract.Version(&_SettlementChainGateway.CallOpts)
}
