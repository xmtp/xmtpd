...
// sequenceKey returns the Redis key for storing the highest generated nonce
func (r *RedisBackedNonceManager) sequenceKey() string {
	return r.keyPrefix + "sequence"
}
...
func (r *RedisBackedNonceManager) GetNonce(
	...
	r.logger.Debug("Generated Nonce", zap.Int64("nonce", nonce))
...
func (r *RedisBackedNonceManager) Replenish(ctx context.Context, nonce big.Int) error {
	...
	pipe.Set(ctx, r.sequenceKey(), startNonce+BatchSize-1, 0)
