...
type PayerReportOptions struct {
	...
	WorkerRepeatIntervalMinutes   uint32        `long:"worker-repeat-interval-minutes"   env:"XMTPD_PAYER_REPORT_WORKER_REPEAT_INTERVAL_MINUTES"   description:"How often payer report workers repeat (minutes)"                                 default:"60"`
	WorkerSpreadMinutes           uint32        `long:"worker-spread-minutes"            env:"XMTPD_PAYER_REPORT_WORKER_SPREAD_MINUTES"            description:"Range of minutes across which to distribute worker execution"                    default:"60"`
}
