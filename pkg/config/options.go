...
type PayerOptions struct {
	...
	NodeSelectorPreferredNodes []uint32      `long:"node-selector-preferred-nodes" env:"XMTPD_PAYER_NODE_SELECTOR_PREFERRED_NODES" env-delim:"," description:"Preferred node IDs"`
