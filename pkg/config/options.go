...
type PayerReportOptions struct {
	...
	GenerateReportSelfPeriod      time.Duration `long:"generate-report-self-period"      env:"XMTPD_PAYER_REPORT_GENERATE_REPORT_SELF_PERIOD"      description:"Period of time we should use to generate payer reports about self"               default:"1h"`
