...
type AppChainOptions struct {
	UseDatabaseClient                bool          `long:"use-database-client"                 env:"XMTPD_APP_CHAIN_USE_DATABASE_CLIENT"               description:"Use pre-decentralization database instead of blockchain"`
