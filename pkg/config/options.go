...
type APIOptions struct {
	...
	RequirePayerPositiveBalance bool          `long:"require-payer-positive-balance" env:"XMTPD_API_REQUIRE_PAYER_POSITIVE_BALANCE" description:"Reject publishes when payer balance is insufficient"     default:"false"`
}
