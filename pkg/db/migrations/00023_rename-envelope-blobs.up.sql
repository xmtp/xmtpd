...
-- Step 3: Recreate the view with the new table name
...
-- Step 4: Replace v1 partition management functions
...
BEGIN
    EXECUTE format(
            ...
            format('gateway_envelopes_blobs_o%s', _oid),
...
-- Step 5: Replace v2 partition management functions
...
-- Step 6: Replace batch insert v1
...
-- Step 7: Replace batch insert v2
