...
SELECT make_meta_originator_part(@originator_node_id);

-- name: MakeBlobOriginatorPart :exec
SELECT make_blob_originator_part(@originator_node_id);

-- name: MakeMetaSeqBand :exec
SELECT make_meta_seq_subpart(@originator_node_id, @band_start, @band_end);

-- name: MakeBlobSeqBand :exec
SELECT make_blob_seq_subpart(@originator_node_id, @band_start, @band_end);
