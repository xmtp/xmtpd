...
WHERE payer_id = @payer_id
	AND (
		@minutes_since_epoch_gt::INTEGER = 0
		OR minutes_since_epoch > @minutes_since_epoch_gt::INTEGER
	)
	AND (
		@minutes_since_epoch_lt::INTEGER = 0
		OR minutes_since_epoch < @minutes_since_epoch_lt::INTEGER
	)
