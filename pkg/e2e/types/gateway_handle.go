...
// newGatewayHandle creates a GatewayHandle wrapping the given gateway.
func newGatewayHandle(gw *gateway.Gateway, index int, chaos *chaos.Controller) *GatewayHandle {
...
func (h *GatewayHandle) AddLatency(ctx context.Context, ms int) error {
	return h.chaos.AddLatency(ctx, h.gateway.Alias(), ms)
}
...
func (h *GatewayHandle) AddBandwidthLimit(ctx context.Context, kbps int) error {
	return h.chaos.AddBandwidthLimit(ctx, h.gateway.Alias(), kbps)
}
...
func (h *GatewayHandle) AddConnectionReset(ctx context.Context, timeoutMs int) error {
	return h.chaos.AddConnectionReset(ctx, h.gateway.Alias(), timeoutMs)
}
...
func (h *GatewayHandle) AddTimeout(ctx context.Context, timeoutMs int) error {
	return h.chaos.AddTimeout(ctx, h.gateway.Alias(), timeoutMs)
}
...
func (h *GatewayHandle) RemoveAllToxics(ctx context.Context) error {
	return h.chaos.RemoveAllToxics(ctx, h.gateway.Alias())
}
