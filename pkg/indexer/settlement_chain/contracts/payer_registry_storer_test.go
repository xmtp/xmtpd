...
func TestPayerRegistryStorer(t *testing.T) {
	...
	testCases := []testCase{
		...
		// Basic event processing
		{
			name: "usage_settled",
			actionLogs: []types.Log{
				tester.newUsageSettledLog(t, address1, 10),
			},
			validate: func(t *testing.T, tester *payerRegistryStorerTester) {
				balance := tester.getBalance(t, address1)
		...
		},
		{
			name: "deposit_single",
			actionLogs: []types.Log{
				tester.newDepositLog(t, address1, 20),
			},
			validate: func(t *testing.T, tester *payerRegistryStorerTester) {
				balance := tester.getBalance(t, address1)
		...
		},
		{
			...
			actionLogs: []types.Log{
				tester.newDepositLog(t, address1, 10),
				tester.newDepositLog(t, address1, 20),
			},
			validate: func(t *testing.T, tester *payerRegistryStorerTester) {
				balance := tester.getBalance(t, address1)
		...
		},
		{
			...
			actionLogs: []types.Log{
				tester.newWithdrawalRequestedLog(t, address1, 10, 100),
			},
			validate: func(t *testing.T, tester *payerRegistryStorerTester) {
				balance := tester.getBalance(t, address1)
				require.Equal(t, currency.FromMicrodollars(10)*-1, balance)
		...
		// Withdrawal cancellation scenarios
		{
			...
			initialLogs: []types.Log{
				tester.newDepositLog(t, address1, 50),
				tester.newWithdrawalRequestedLog(t, address1, 20, 100),
			},
			actionLogs: []types.Log{
				tester.newWithdrawalCancelledLog(t, address1),
			},
			validate: func(t *testing.T, tester *payerRegistryStorerTester) {
				balance := tester.getBalance(t, address1)
		...
		},
		{
			...
			initialLogs: []types.Log{
				tester.newDepositLog(t, address1, 100),
				tester.newWithdrawalRequestedLog(t, address1, 30, 100),
				tester.newWithdrawalRequestedLog(t, address1, 20, 200),
			},
			actionLogs: []types.Log{
				tester.newWithdrawalCancelledLog(t, address1),
			},
...
func TestStoreLogIdempotency(t *testing.T) {
	...
	depositLog := tester.newDepositLog(t, address1, 50)
	withdrawalLog := tester.newWithdrawalRequestedLog(t, address1, 30, 100)
	usageLog := tester.newUsageSettledLog(t, address1, 25)
	cancellationLog := tester.newWithdrawalCancelledLog(t, address1)
	...
	testCases := []testCase{
		...
		},
		{
			...
			initialLogs: []types.Log{
				tester.newDepositLog(t, address1, 100),
				tester.newWithdrawalRequestedLog(t, address1, 40, 100),
			},
			actionLogs: []types.Log{
				cancellationLog,
