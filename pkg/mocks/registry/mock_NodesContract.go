...
func (_m *MockNodesContract) AllNodes(opts *bind.CallOpts) ([]abis.NodesNodeWithId, error) {
	...
	var r0 []abis.NodesNodeWithId
	var r1 error
	if rf, ok := ret.Get(0).(func(*bind.CallOpts) ([]abis.NodesNodeWithId, error)); ok {
		return rf(opts)
	}
	if rf, ok := ret.Get(0).(func(*bind.CallOpts) []abis.NodesNodeWithId); ok {
		r0 = rf(opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]abis.NodesNodeWithId)
		}
	}
