...
// StoreLog provides a mock function with given fields: ctx, event, appendLog
func (_m *MockLogStorer) StoreLog(ctx context.Context, event types.Log, appendLog bool) storer.LogStorageError {
	ret := _m.Called(ctx, event, appendLog)
	...
	if rf, ok := ret.Get(0).(func(context.Context, types.Log, bool) storer.LogStorageError); ok {
		r0 = rf(ctx, event, appendLog)
	} else {
		if ret.Get(0) != nil {
...
//   - event types.Log
//   - appendLog bool
func (_e *MockLogStorer_Expecter) StoreLog(ctx interface{}, event interface{}, appendLog interface{}) *MockLogStorer_StoreLog_Call {
	return &MockLogStorer_StoreLog_Call{Call: _e.mock.On("StoreLog", ctx, event, appendLog)}
}

func (_c *MockLogStorer_StoreLog_Call) Run(run func(ctx context.Context, event types.Log, appendLog bool)) *MockLogStorer_StoreLog_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.Log), args[2].(bool))
	})
	return _c
}
...
func (_c *MockLogStorer_StoreLog_Call) RunAndReturn(run func(context.Context, types.Log, bool) storer.LogStorageError) *MockLogStorer_StoreLog_Call {
	_c.Call.Return(run)
	return _c
}
