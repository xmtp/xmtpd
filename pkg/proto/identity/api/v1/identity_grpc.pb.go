...
func (c *identityApiClient) PublishIdentityUpdate(ctx context.Context, in *PublishIdentityUpdateRequest, opts ...grpc.CallOption) (*PublishIdentityUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityApi_PublishIdentityUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityApiClient) GetIdentityUpdates(ctx context.Context, in *GetIdentityUpdatesRequest, opts ...grpc.CallOption) (*GetIdentityUpdatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityApi_GetIdentityUpdates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityApiClient) GetInboxIds(ctx context.Context, in *GetInboxIdsRequest, opts ...grpc.CallOption) (*GetInboxIdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityApi_GetInboxIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityApiClient) VerifySmartContractWalletSignatures(ctx context.Context, in *VerifySmartContractWalletSignaturesRequest, opts ...grpc.CallOption) (*VerifySmartContractWalletSignaturesResponse, error) {
	...
	err := c.cc.Invoke(ctx, IdentityApi_VerifySmartContractWalletSignatures_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedIdentityApiServer
...
// UnimplementedIdentityApiServer should be embedded to have
...
func (UnimplementedIdentityApiServer) testEmbeddedByValue() {}
...
func RegisterIdentityApiServer(s grpc.ServiceRegistrar, srv IdentityApiServer) {
	// If the following call pancis, it indicates UnimplementedIdentityApiServer was
