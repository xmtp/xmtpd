...
type MlsApiClient interface {
	...
	SubscribeGroupMessages(ctx context.Context, in *SubscribeGroupMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GroupMessage], error)
	// Subscribe stream of new welcome messages
	SubscribeWelcomeMessages(ctx context.Context, in *SubscribeWelcomeMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WelcomeMessage], error)
...
func (c *mlsApiClient) SendGroupMessages(ctx context.Context, in *SendGroupMessagesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_SendGroupMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) SendWelcomeMessages(ctx context.Context, in *SendWelcomeMessagesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MlsApi_SendWelcomeMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) RegisterInstallation(ctx context.Context, in *RegisterInstallationRequest, opts ...grpc.CallOption) (*RegisterInstallationResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_RegisterInstallation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) UploadKeyPackage(ctx context.Context, in *UploadKeyPackageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MlsApi_UploadKeyPackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) FetchKeyPackages(ctx context.Context, in *FetchKeyPackagesRequest, opts ...grpc.CallOption) (*FetchKeyPackagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_FetchKeyPackages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) RevokeInstallation(ctx context.Context, in *RevokeInstallationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MlsApi_RevokeInstallation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) GetIdentityUpdates(ctx context.Context, in *GetIdentityUpdatesRequest, opts ...grpc.CallOption) (*GetIdentityUpdatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_GetIdentityUpdates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) QueryGroupMessages(ctx context.Context, in *QueryGroupMessagesRequest, opts ...grpc.CallOption) (*QueryGroupMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_QueryGroupMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) QueryWelcomeMessages(ctx context.Context, in *QueryWelcomeMessagesRequest, opts ...grpc.CallOption) (*QueryWelcomeMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_QueryWelcomeMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) SubscribeGroupMessages(ctx context.Context, in *SubscribeGroupMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GroupMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MlsApi_ServiceDesc.Streams[0], MlsApi_SubscribeGroupMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeGroupMessagesRequest, GroupMessage]{ClientStream: stream}
...
type MlsApi_SubscribeGroupMessagesClient = grpc.ServerStreamingClient[GroupMessage]

func (c *mlsApiClient) SubscribeWelcomeMessages(ctx context.Context, in *SubscribeWelcomeMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WelcomeMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MlsApi_ServiceDesc.Streams[1], MlsApi_SubscribeWelcomeMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeWelcomeMessagesRequest, WelcomeMessage]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MlsApi_SubscribeWelcomeMessagesClient = grpc.ServerStreamingClient[WelcomeMessage]

func (c *mlsApiClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeRequest, SubscribeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MlsApi_ServiceDesc.Streams[2], MlsApi_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MlsApi_SubscribeClient = grpc.BidiStreamingClient[SubscribeRequest, SubscribeResponse]
...
func (c *mlsApiClient) BatchPublishCommitLog(ctx context.Context, in *BatchPublishCommitLogRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MlsApi_BatchPublishCommitLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) BatchQueryCommitLog(ctx context.Context, in *BatchQueryCommitLogRequest, opts ...grpc.CallOption) (*BatchQueryCommitLogResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_BatchQueryCommitLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mlsApiClient) GetNewestGroupMessage(ctx context.Context, in *GetNewestGroupMessageRequest, opts ...grpc.CallOption) (*GetNewestGroupMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, MlsApi_GetNewestGroupMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedMlsApiServer
...
type MlsApiServer interface {
	...
	// Subscribe stream of new group messages
	SubscribeGroupMessages(*SubscribeGroupMessagesRequest, grpc.ServerStreamingServer[GroupMessage]) error
	// Subscribe stream of new welcome messages
	SubscribeWelcomeMessages(*SubscribeWelcomeMessagesRequest, grpc.ServerStreamingServer[WelcomeMessage]) error
	// Bidirectional subscription (XIP-83). One long-lived stream the client mutates
	// in place via add/remove topic deltas, with WebSocket-style liveness ping/pong.
	// A single stream MAY carry both group-message and welcome topics.
	// gRPC-only: bidirectional streaming has no HTTP/grpc-gateway mapping.
...
// UnimplementedMlsApiServer should be embedded to have
...
func (UnimplementedMlsApiServer) SubscribeGroupMessages(*SubscribeGroupMessagesRequest, grpc.ServerStreamingServer[GroupMessage]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeGroupMessages not implemented")
}
func (UnimplementedMlsApiServer) SubscribeWelcomeMessages(*SubscribeWelcomeMessagesRequest, grpc.ServerStreamingServer[WelcomeMessage]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeWelcomeMessages not implemented")
}
func (UnimplementedMlsApiServer) Subscribe(grpc.BidiStreamingServer[SubscribeRequest, SubscribeResponse]) error {
...
func (UnimplementedMlsApiServer) testEmbeddedByValue() {}
...
func RegisterMlsApiServer(s grpc.ServiceRegistrar, srv MlsApiServer) {
	// If the following call pancis, it indicates UnimplementedMlsApiServer was
...
func _MlsApi_SubscribeGroupMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MlsApiServer).SubscribeGroupMessages(m, &grpc.GenericServerStream[SubscribeGroupMessagesRequest, GroupMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MlsApi_SubscribeGroupMessagesServer = grpc.ServerStreamingServer[GroupMessage]
...
func _MlsApi_SubscribeWelcomeMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(MlsApiServer).SubscribeWelcomeMessages(m, &grpc.GenericServerStream[SubscribeWelcomeMessagesRequest, WelcomeMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MlsApi_SubscribeWelcomeMessagesServer = grpc.ServerStreamingServer[WelcomeMessage]

func _MlsApi_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MlsApiServer).Subscribe(&grpc.GenericServerStream[SubscribeRequest, SubscribeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MlsApi_SubscribeServer = grpc.BidiStreamingServer[SubscribeRequest, SubscribeResponse]
