...
type ConsentEntityType int32

const (
	ConsentEntityType_CONSENT_ENTITY_TYPE_UNSPECIFIED     ConsentEntityType = 0
	ConsentEntityType_CONSENT_ENTITY_TYPE_CONVERSATION_ID ConsentEntityType = 1
	ConsentEntityType_CONSENT_ENTITY_TYPE_INBOX_ID        ConsentEntityType = 2
	ConsentEntityType_CONSENT_ENTITY_TYPE_ADDRESS         ConsentEntityType = 3
)

// Enum value maps for ConsentEntityType.
var (
	ConsentEntityType_name = map[int32]string{
		0: "CONSENT_ENTITY_TYPE_UNSPECIFIED",
		1: "CONSENT_ENTITY_TYPE_CONVERSATION_ID",
		2: "CONSENT_ENTITY_TYPE_INBOX_ID",
		3: "CONSENT_ENTITY_TYPE_ADDRESS",
	}
	ConsentEntityType_value = map[string]int32{
...
func (x ConsentEntityType) Enum() *ConsentEntityType {
	p := new(ConsentEntityType)
	*p = x
	return p
}

func (x ConsentEntityType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ConsentEntityType) Descriptor() protoreflect.EnumDescriptor {
	return file_mls_message_contents_content_proto_enumTypes[2].Descriptor()
}

func (ConsentEntityType) Type() protoreflect.EnumType {
	return &file_mls_message_contents_content_proto_enumTypes[2]
}

func (x ConsentEntityType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ConsentEntityType.Descriptor instead.
func (ConsentEntityType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ConsentState_CONSENT_STATE_ALLOWED     ConsentState = 1
	ConsentState_CONSENT_STATE_DENIED      ConsentState = 2
)
...
var (
	ConsentState_name = map[int32]string{
		...
		1: "CONSENT_STATE_ALLOWED",
		2: "CONSENT_STATE_DENIED",
	}
...
func (ConsentState) Descriptor() protoreflect.EnumDescriptor {
	return file_mls_message_contents_content_proto_enumTypes[3].Descriptor()
}

func (ConsentState) Type() protoreflect.EnumType {
	return &file_mls_message_contents_content_proto_enumTypes[3]
}
...
type ConsentUpdate struct {
	...
	EntityType ConsentEntityType `protobuf:"varint,1,opt,name=entity_type,json=entityType,proto3,enum=xmtp.mls.message_contents.ConsentEntityType" json:"entity_type,omitempty"`
	State      ConsentState      `protobuf:"varint,2,opt,name=state,proto3,enum=xmtp.mls.message_contents.ConsentState" json:"state,omitempty"`
	Entity     string            `protobuf:"bytes,3,opt,name=entity,proto3" json:"entity,omitempty"`
}

func (x *ConsentUpdate) Reset() {
	*x = ConsentUpdate{}
...
func (x *ConsentUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConsentUpdate) ProtoMessage() {}

func (x *ConsentUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_mls_message_contents_content_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConsentUpdate.ProtoReflect.Descriptor instead.
func (*ConsentUpdate) Descriptor() ([]byte, []int) {
	return file_mls_message_contents_content_proto_rawDescGZIP(), []int{6}
}

func (x *ConsentUpdate) GetEntityType() ConsentEntityType {
	if x != nil {
		return x.EntityType
	}
	return ConsentEntityType_CONSENT_ENTITY_TYPE_UNSPECIFIED
}

func (x *ConsentUpdate) GetState() ConsentState {
	if x != nil {
		return x.State
	}
...
func (x *ConsentUpdate) GetEntity() string {
	if x != nil {
		return x.Entity
	}
	return ""
...
type PlaintextEnvelope_V2 struct {
	...
	//	*PlaintextEnvelope_V2_ConsentUpdate
...
func (x *PlaintextEnvelope_V2) GetConsentUpdate() *ConsentUpdate {
	if x, ok := x.GetMessageType().(*PlaintextEnvelope_V2_ConsentUpdate); ok {
		return x.ConsentUpdate
	}
	return nil
}
...
type PlaintextEnvelope_V2_ConsentUpdate struct {
	// A streamed cosnent update
	ConsentUpdate *ConsentUpdate `protobuf:"bytes,5,opt,name=consent_update,json=consentUpdate,proto3,oneof"`
}
...
func (*PlaintextEnvelope_V2_ConsentUpdate) isPlaintextEnvelope_V2_MessageType() {}
...
var file_mls_message_contents_content_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xd6, 0x04, 0x0a, 0x11, 0x50, 0x6c,
	...
	0x69, 0x64, 0x65, 0x6d, 0x70, 0x6f, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x4b, 0x65, 0x79, 0x1a, 0xe6,
	...
	,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x69, 0x6e, 0x5f, 0x63,
	0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x69, 0x6e, 0x43, 0x6f,
	0x64, 0x65, 0x12, 0x3d, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e,
	...
	0x64, 0x22, 0xf9, 0x01, 0x0a, 0x0f, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53, 0x79, 0x6e, 0x63,
	...
	0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x53, 0x0a, 0x0e, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c,
	0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x53, 0x79, 0x6e, 0x63, 0x4b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0d, 0x65, 0x6e,
	0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x74,
	...
	0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x78,
	0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53,
	0x79, 0x6e, 0x63, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x3c, 0x0a,
	...
	,
	...
	0x69, 0x74, 0x79, 0x2a, 0x3c, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69,
	...
	,
...
var file_mls_message_contents_content_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_mls_message_contents_content_proto_goTypes = []any{
	...
	(ConsentEntityType)(0),       // 2: xmtp.mls.message_contents.ConsentEntityType
	(ConsentState)(0),            // 3: xmtp.mls.message_contents.ConsentState
	(*ContentTypeId)(nil),        // 4: xmtp.mls.message_contents.ContentTypeId
	(*EncodedContent)(nil),       // 5: xmtp.mls.message_contents.EncodedContent
	(*PlaintextEnvelope)(nil),    // 6: xmtp.mls.message_contents.PlaintextEnvelope
	(*DeviceSyncRequest)(nil),    // 7: xmtp.mls.message_contents.DeviceSyncRequest
	(*DeviceSyncReply)(nil),      // 8: xmtp.mls.message_contents.DeviceSyncReply
	(*DeviceSyncKeyType)(nil),    // 9: xmtp.mls.message_contents.DeviceSyncKeyType
	(*ConsentUpdate)(nil),        // 10: xmtp.mls.message_contents.ConsentUpdate
	nil,                          // 11: xmtp.mls.message_contents.EncodedContent.ParametersEntry
	(*PlaintextEnvelope_V1)(nil), // 12: xmtp.mls.message_contents.PlaintextEnvelope.V1
	(*PlaintextEnvelope_V2)(nil), // 13: xmtp.mls.message_contents.PlaintextEnvelope.V2
}
var file_mls_message_contents_content_proto_depIdxs = []int32{
	4,  // 0: xmtp.mls.message_contents.EncodedContent.type:type_name -> xmtp.mls.message_contents.ContentTypeId
	11, // 1: xmtp.mls.message_contents.EncodedContent.parameters:type_name -> xmtp.mls.message_contents.EncodedContent.ParametersEntry
	0,  // 2: xmtp.mls.message_contents.EncodedContent.compression:type_name -> xmtp.mls.message_contents.Compression
	12, // 3: xmtp.mls.message_contents.PlaintextEnvelope.v1:type_name -> xmtp.mls.message_contents.PlaintextEnvelope.V1
	13, // 4: xmtp.mls.message_contents.PlaintextEnvelope.v2:type_name -> xmtp.mls.message_contents.PlaintextEnvelope.V2
	1,  // 5: xmtp.mls.message_contents.DeviceSyncRequest.kind:type_name -> xmtp.mls.message_contents.DeviceSyncKind
	9,  // 6: xmtp.mls.message_contents.DeviceSyncReply.encryption_key:type_name -> xmtp.mls.message_contents.DeviceSyncKeyType
	1,  // 7: xmtp.mls.message_contents.DeviceSyncReply.kind:type_name -> xmtp.mls.message_contents.DeviceSyncKind
	2,  // 8: xmtp.mls.message_contents.ConsentUpdate.entity_type:type_name -> xmtp.mls.message_contents.ConsentEntityType
	3,  // 9: xmtp.mls.message_contents.ConsentUpdate.state:type_name -> xmtp.mls.message_contents.ConsentState
	7,  // 10: xmtp.mls.message_contents.PlaintextEnvelope.V2.device_sync_request:type_name -> xmtp.mls.message_contents.DeviceSyncRequest
	8,  // 11: xmtp.mls.message_contents.PlaintextEnvelope.V2.device_sync_reply:type_name -> xmtp.mls.message_contents.DeviceSyncReply
	10, // 12: xmtp.mls.message_contents.PlaintextEnvelope.V2.consent_update:type_name -> xmtp.mls.message_contents.ConsentUpdate
...
func file_mls_message_contents_content_proto_init() {
	...
	file_mls_message_contents_content_proto_msgTypes[9].OneofWrappers = []any{
		...
		(*PlaintextEnvelope_V2_ConsentUpdate)(nil),
	}
	type x struct{}
