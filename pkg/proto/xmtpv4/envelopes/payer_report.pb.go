...
type PayerReport struct {
	...
	NodesHash []byte `protobuf:"bytes,6,opt,name=nodes_hash,json=nodesHash,proto3" json:"nodes_hash,omitempty"`
	// The number of nodes in the report
	NodesCount    uint32 `protobuf:"varint,7,opt,name=nodes_count,json=nodesCount,proto3" json:"nodes_count,omitempty"`
...
func (x *PayerReport) GetNodesHash() []byte {
	if x != nil {
		return x.NodesHash
	}
	return nil
...
func (x *PayerReport) GetNodesCount() uint32 {
	if x != nil {
		return x.NodesCount
	}
	return 0
...
const file_xmtpv4_envelopes_payer_report_proto_rawDesc = "" +
	"\n" +
	"#xmtpv4/envelopes/payer_report.proto\x12\x15xmtp.xmtpv4.envelopes\x1a%identity/associations/signature.proto\"\xa9\x02\n" +
	"\vPayerReport\x12,\n" +
	...
	"\x11payers_leaf_count\x18\x05 \x01(\rR\x0fpayersLeafCount\x12\x1d\n" +
	"\n" +
	"nodes_hash\x18\x06 \x01(\fR\tnodesHash\x12\x1f\n" +
	"\vnodes_count\x18\a \x01(\rR\n" +
	"nodesCount\"\x8a\x01\n" +
