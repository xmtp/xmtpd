...
func (c *misbehaviorApiClient) SubmitMisbehaviorReport(ctx context.Context, in *SubmitMisbehaviorReportRequest, opts ...grpc.CallOption) (*SubmitMisbehaviorReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, MisbehaviorApi_SubmitMisbehaviorReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *misbehaviorApiClient) QueryMisbehaviorReports(ctx context.Context, in *QueryMisbehaviorReportsRequest, opts ...grpc.CallOption) (*QueryMisbehaviorReportsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MisbehaviorApi_QueryMisbehaviorReports_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedMisbehaviorApiServer
...
// UnimplementedMisbehaviorApiServer should be embedded to have
...
func (UnimplementedMisbehaviorApiServer) testEmbeddedByValue() {}
...
func RegisterMisbehaviorApiServer(s grpc.ServiceRegistrar, srv MisbehaviorApiServer) {
	// If the following call pancis, it indicates UnimplementedMisbehaviorApiServer was
